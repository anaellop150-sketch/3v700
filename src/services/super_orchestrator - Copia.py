...
class SuperOrchestrator:
    ...
    def _execute_social_analysis(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """Executa análise de redes sociais (desativada)"""
        logger.info("📱 Iniciando análise de redes sociais com EXA.        try:
            query = data.get("query") or f"redes sociais {data.get(\'segmento\', \'\')} {data.get(\'produto\', \'\')} YouTube" # Dobrar o tamanho da pesquisa, extração e análise           # Usar EXA para buscas em redes sociais e YouTube
